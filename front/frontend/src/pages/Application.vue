              ...
              <form class="application" @submit.prevent="submitData">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <select class="custom-select" id="loanType" v-model="state.selected['loanType']" required>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <select class="custom-select" id="deposit" v-model="state.selected['deposit']" required>
                  ...
                  <div class="col-sm-6">
                    ...
                    <select class="custom-select" id="loanTerm" v-model="state.selected['loanTerm']" required>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <select class="custom-select" id="interestType" v-model="state.selected['interestType']" required>
